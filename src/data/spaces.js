export const SPACES = [
  ...
  {
    id: "samudra-theeram",
    slug: "samudra-theeram",
    name: "Samudra Theeram",
    tagline: "సముద్రపు అలల సవ్వడి & సూర్యోదయ సూర్యాస్తమయ మధుర గీతాలు",
    emoji: "🌊",
    active: true,
    isNew: true,
    theme: "cyan",
    description: "24-hour day and night ocean cycle with realistic raymarched waves, sunrise to sunset transitions, and soothing Telugu beach melodies.",
  },
  {
    id: "palle-velugu",
    slug: "palle-velugu",
