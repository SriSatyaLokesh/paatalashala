...
export const SPACE_THEMES = {
  'tractor-anna': {
    ...
    getQuote: (song) => stripEmoji(song?.quote || 'చేను చెలకా మనదేరా, రైతు అన్న రాజేరా!'),
  ...
  auto: {
    ...
    getQuote: (song) => stripEmoji(song?.quote || 'Andhamaina ammayini, finance lo theskuna auto ni maintain cheyandam kastam.'),
  ...
  ammama: {
    ...
    getQuote: (song) => AMMAMA_LYRICS[song.__localIndex % AMMAMA_LYRICS.length],
